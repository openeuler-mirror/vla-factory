...
def build_pipeline(plan, ctx: TransformContext) -> TransformPipeline:
    ...
    An empty plan is a valid identity pipeline. Whether that identity is
    semantically valid is decided while resolving the assembly, before this
    construction-only function is called.
    """
